                ...
                >
                  <View style={styles.carouselImgDiv}>
                    <Image
                      ...
                      source={data.img[0].image}
                    />
                    <Image
                      style={styles.carouselImg}
                      source={data.img[1].image}
                    />
                    <Image
                      style={styles.carouselImg}
                      source={data.img[2].image}
                    />
                    <Image
                      style={styles.carouselImg}
                      source={data.img[3].image}
                    />
                    <Image
                      style={styles.carouselImg}
                      source={data.img[4].image}
                    />
                  </View>
                </ScrollView>
              </View>
